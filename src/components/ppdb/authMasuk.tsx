...
// import AuthContext from "../../context/authProvider"bere
...
const AuthMasuk = ({
    ...
    const loginHandler = (data: any) => {
        ...
        axiosBaseUrl.post("/api/v1/auth/login", {
            username: noWhatsapp,
            password
        })
            .then(res => {
    ...
    if (auth === "masuk") return (
        ...
        >
            ...
            >
                ...
                <Link style={{ textDecoration: "none", color: "inherit" }} to={'https://wa.me/6281380908008'} >
                    Lupa Password?
                </Link>
