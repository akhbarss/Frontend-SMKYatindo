...
const GelombangPPDB = ({
    ...
    const tanggalMulai = pilihanGelombang && new Date(pilihanGelombang?.waktu_dibuka)
    const tanggalSelesai = pilihanGelombang && new Date(pilihanGelombang?.waktu_ditutup)
    const waktuSekarang = new Date()

    const timeDifference = tanggalSelesai && waktuSekarang && (tanggalSelesai.getTime() - waktuSekarang.getTime());

    const daysRemaining = timeDifference && Math.ceil(timeDifference / (1000 * 60 * 60 * 24));
    ...
    const clickHandler = (data: JalurPendaftaranPPDB) => {
        ...
        modals.openContextModal({
            ...
            innerProps: {
                ...
                onCancel,
                modalBody:
                    `Anda yakin ingin memilih ${data.nama_jalur_pendaftaran}?`,
            },
        })
    }
    ...
    const contentGelombang = <>
        {
            data.map(jalur => {
                ...
                const isJalurDibuka = waktuSekarang >= tanggalMulai && waktuSekarang <= tanggalSelesai;
                ...
                return (
                    <Button
                        ...
                        style={{
                            ...
                            backgroundColor: `${`${jalur.id}` === focus ? dark ? "rgba(51,102,255,0.2)" : "rgba(193, 227, 255, 1)" : ""}`,
                    ...
                    >
                        <Group>
                            ...
                            <Box>
                                ...
                                <Text align="left">{tanggalMulai.toLocaleDateString("id-ID", {
                                    day: "2-digit",
                                    month: "long",
                                    year: "numeric"
        ...
        <>
            ...
            >
                ...
                >
                    ...
                    {
                        daysRemaining && daysRemaining > 0 ? `${daysRemaining} Hari Lagi` : "Ditutup"
                    }
