...
const JalurPendaftaranAdminSMP = () => {
    ...
    const formCreateMantine = useFormMantine<FormValuesCreateJalur>({
        ...
        transformValues: (values) => ({
            ...values,
            biayaPendaftaran: values.biayaPendaftaran && +(values.biayaPendaftaran as unknown as string).substring(4).replace(/\./g, ""),
    ...
    const {
        ...
        queryKey: ["get-all-jalur-pendaftaran" + "SMP"],
...
export default JalurPendaftaranAdminSMP