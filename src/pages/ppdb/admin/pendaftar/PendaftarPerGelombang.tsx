                    ...
                    >
                        <Box  >
                            ...
                            {loadTotalPendaftar ? (
                                ...
                                <Text c={`${dark ? "white" : "black"}`} weight={"bold"} size={"xl"} align="center">{totalPendaftar?.data?.registered} Orang</Text>
                            )}
                        </Box>
                        <Box  >
                        ...
                        <Box  >
                            ...
                            {loadTotalPendaftar ? (
                                ...
                                <Text c={`${dark ? "white" : "black"}`} weight={"bold"} size={"xl"} align="center">{totalPendaftar?.data?.diterima} Orang</Text>
                            )}
                        </Box>
                    </Box>
                </Paper>
