        ...
        <>
            <Stack>
                <Box
                    ...
                    sx={{
                        background: "linear-gradient(to left, rgba(141, 108, 255, 1), rgba(51, 154, 240, 1))",
                        padding: "3rem 3rem",
                        borderRadius: "5px",
                        color: "white",
                        display: "flex",
...

                {
                    showAlert && (
                        ...
                        >
                            Selamat, data anda telah terdata di sistem kami. harap lanjutkan pembelian formulir untuk melanjutkan proses pendaftaran
                        </Alert>
                    )
                }
                ...
                <Button onClick={async () => {
                    ...
                    const response = await fetch("http://localhost:8080/api/v1/admin/alur-ppdb/index?userId=1", {
                        headers: {
                            "Authorization": "Bearer eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhZG1pbiIsImlhdCI6MTY5Nzc4OTgwMywiZXhwIjoxNjk3ODc2MjAzfQ.DowHCxhygbzldjHFxmvyFkkJ1hlEVYBE03PVzhNegU4"
                        },
                        credentials: "include"
                    ...
                    <Card shadow='xl'>
                        ...
                        <Timeline active={active} bulletSize={24} lineWidth={2} >
                            <Timeline.Item
                                ...
                                lineVariant='solid'
                            >
                                <Text color="dimmed" size="sm">Wa admin 0838382323</Text>
                                {/* <Text size="xs" mt={4}>2 hours ago</Text> */}
                            </Timeline.Item>

                            <Timeline.Item bullet={<FaCheck size={12} />} title="Pengembalian Formulir">
